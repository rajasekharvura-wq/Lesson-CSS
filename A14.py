...
# STEP 1 - Create tuples for recipe details (fixed - cannot be changed after creation)
pasta = ("Pasta Arrabitia", "Italian", 20, "Medium")
biryani= ("Chicken Biryani", "Indian", 45, "Hard")
print("Recipe Details 1:", pasta)
print("Name", pasta[0])
...
print("Second recipe cooking time:", all_recipes[1][2], "mins")
